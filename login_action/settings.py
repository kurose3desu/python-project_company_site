"""
Django settings for login_action project.
...
SECRET_KEY = 'tlnoz15ark7*kp^1bi@frb#dd=1hyoi-q-o!*isn6owyy9(h$3'
...
ROOT_URLCONF = 'login_action.urls'
...
WSGI_APPLICATION = 'login_action.wsgi.application'
